...
The current ring implementation is an exact bounded-memory reference kernel.
It establishes end-to-end equation parity while the fused THC kernel replaces
that hotspot; metadata therefore marks this engine as correctness eligible but
not yet performance eligible.
"""
    ...
    def kernel(
        ...
        *,
        ...
        self.metrics.metadata.update({
            ...
            "ring_kernel": "bounded-memory-reference",
