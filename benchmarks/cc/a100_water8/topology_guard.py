...
def _write_new_record(path: Path, decision: TopologyDecision) -> str:
    ...
    try:
        ...
        while view:
            ...
            if written < 1:
                raise OSError("topology record write made no progress")
            view = view[written:]
        os.fsync(descriptor)
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    topology_sha256 = _write_new_record(args.record, decision)
    print(
    ...
    environment.update(
        {
            ...
            "CCSD_TOPOLOGY_SHA256": topology_sha256,
